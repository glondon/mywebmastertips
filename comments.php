...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments"><?php comments_number('Add a Comment', 'One Comment', '% Comments' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" style="margin-top:10px" />
